...
- **`ring`** (GEOSisRing): Tests whether the input geometry is a ring. Rings are linestrings, without self-intersections, with start and end point being identical. Returns: 1 on true, 0 on false, 2 on exception.
- **`closed`** (GEOSisClosed): Tests whether the input geometry is closed. A closed geometry is a linestring or multilinestring with the start and end points being the same. Returns:  1 on true, 0 on false, 2 on exception
